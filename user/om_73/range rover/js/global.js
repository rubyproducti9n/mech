...
document.getElementById("grp-img").innerHTML = '<img src="' + img + '" class="grp-img" draggable="false">', document.getElementById("grp-nme").innerHTML = name, document.getElementById("grp-roll").innerHTML = roll, document.getElementById("grp-brh").innerHTML = branch;
